...
const becabeLogo = "/optimized/becabe-small.webp";
...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "Instagram",
      href: "https://www.instagram.com/beliconamx/",
      icon: (
        <svg
          className="w-6 h-6"
          fill="currentColor"
    ...
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@belicona_oficial",
      icon: (
        <svg
          className="w-6 h-6"
          fill="currentColor"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@beliconamx",
      icon: (
        <svg
          className="w-6 h-6"
          fill="currentColor"
                    ...
                    switch (name) {
                      ...
                      case "YouTube":
                        return {
                          ...
                          hoverBg: "from-red-500/40 to-red-600/40",
                          border: "border-red-500/30",
                          hoverBorder: "border-red-500/60",
                          shadow: "shadow-red-500/30",
                          text: "text-red-400",
                          hoverText: "text-red-300",
                        };
                      default:
                        return {
                          bg: "from-gray-800/60 to-gray-900/60",
